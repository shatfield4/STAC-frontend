...
export const StagingBaconContractABI = [
  ...
  },
  {
    inputs: [],
    name: 'greaseERC20',
    outputs: [{ internalType: 'contract IGREASE', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'address', name: '_fryingPanAddress', type: 'address' },
    ],
    name: 'setFryingPan',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'address', name: '_newGreaseAddress', type: 'address' },
    ],
    name: 'setGrease',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'theFryingPan',
    outputs: [
      { internalType: 'contract IFRYINGPAN', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
